...
abstract class DocumentEnum
{
    ...
    const RCCM_EXTRACT = "Extrait du RCCM";
    const IDENTITY_DOCUMENT = "Pièce d'identité";
    const EVIDENCE = "Preuves";
    const PV = "Procès verbal";
    const NIF_CERTIFICATE = "Attestation du NIF";
    const BAIL_CONTRACT = "Contrat de bail";
}
